...
const roadmapSteps = [
  ...
  },
  {
    ...
    description: 'Sử dụng dashboard để tìm ra các "lỗ rò rỉ" tiền bạc: Đơn hoàn trả, phí sàn tính sai, quảng cáo không ra đơn. Cắt giảm lãng phí, thu hồi công nợ.',
    icon: 'fa-cogs',
  },
  {
    stage: 'Giai đoạn 3',
    ...
    description: 'Phân tích hiệu quả Cross-channel (Facebook -> Sàn). Xác định sản phẩm "Key Hero" và kênh "Winner" để dồn ngân sách scale up.',
    icon: 'fa-rocket',
  },
  {
    stage: 'Giai đoạn 4',
