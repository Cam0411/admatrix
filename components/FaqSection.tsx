...
const faqItems = [
    { question: "Dữ liệu của tôi nằm ở đâu? (Data Ownership)", answer: "Hệ thống phải hỗ trợ kiến trúc Zero-copy hoặc Composable, cho phép dữ liệu nằm nguyên tại Warehouse của bạn (BigQuery, Snowflake). Bạn phải là người nắm giữ chìa khóa." },
    { question: "Khả năng 'Identity Resolution' (Hợp nhất định danh) hoạt động như thế nào?", answer: "Cần có thuật toán ghép nối chính xác (Deterministic & Probabilistic) để tạo ra góc nhìn khách hàng 360 độ chân thực, không phải một cái kho chứa rác." },
    { question: "Nền tảng có sẵn sàng cho kỷ nguyên Agentic AI không?", answer: "Phải có API mở và lớp ngữ nghĩa (Semantic Layer) để các AI Agent có thể truy cập, hiểu và tự động triển khai chiến dịch mà không cần can thiệp thủ công." },
    ...
    { question: "Giải pháp đáp ứng Nghị định 13 (Việt Nam) và các tiêu chuẩn bảo mật 2026 ra sao?", answer: "Cần tích hợp sẵn cơ chế quản lý sự đồng ý (Consent Management), mã hóa dữ liệu đầu cuối và các giao thức bảo mật lớp doanh nghiệp." },
    ...
    { question: "Bạn đo lường 'Incremental Lift' (Tăng trưởng thực tế) như thế nào?", answer: "Hệ thống phải hỗ trợ thử nghiệm A/B Testing ở cấp độ dữ liệu để chứng minh sự tăng trưởng doanh thu thực tế, không phải chỉ số ảo (Vanity Metrics)." },
    ...
    { question: "Khả năng kết nối (Activation) với hệ sinh thái quảng cáo hiện có?", answer: "MDP chỉ có giá trị khi nó 'nói chuyện' được với Facebook, Google, Tiktok, CRM, Email... Cần có sẵn các đầu nối (Connector) hai chiều và API linh hoạt." },
    { question: "Thời gian để thấy được giá trị đầu tiên (Time to Value) là bao lâu?", answer: "Lộ trình triển khai phải theo từng giai đoạn (Quick-wins). Phải thấy được kết quả đo lường được trong vòng 3-6 tháng đầu tiên, không phải các dự án kéo dài hàng năm." }
];
